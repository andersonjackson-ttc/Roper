...
Sub Clear_Output()
    ...
    toPath = Workbooks("RoomForm3P.xlsm").Sheets("Menu").Range("$A$40").Value ' change name
    ...
    ActiveWorkbook.Sheets("All Therapists").Range("LastRowCell3W").Value = 1 ' change this
